        ...
        <div className="privacy-container">
          <form action="#" method="POST">
            <div className="privacy-option">
              <label htmlFor="profileVisibility" className="privacy-option__label">
                Profile Visibility:
              </label>
              <select
            ...
            <div className="privacy-option">
              <label htmlFor="postVisibility" className="privacy-option__label">
                Post Visibility:
              </label>
              <select
                name="postVisibility"
              ...
              <p className="privacy-option__description">Who can see your posts?</p>
            </div>

            <div className="privacy-line"></div>

            <div className="privacy-option">
              <label htmlFor="contactPreference" className="privacy-option__label">
                Who can contact me:
              </label>
              <select
            ...
            <div className="privacy-option">
              <label htmlFor="findPreference" className="privacy-option__label">
              ...
              >
                ...
                <option value="friendRequests">Only through friend requests</option>
