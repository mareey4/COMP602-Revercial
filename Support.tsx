...
import { generateTicketID, checkExistingTicketID } from "./TicketGenerator";
        ...
        <div className="descriptionContainer">
          ...
          <textarea
            ...
            className={`descriptionTextArea ${
              isTextAreaFocused || description !== "" ? "" : "placeholder"
            }`}
            ...
            placeholder={
              isPlaceholderVisible ? "Write description here..." : ""
            }
          />
          <div className="charCount">{charCount}/500 characters</div>
        </div>
